      ...
      <h2 id="job-history-heading" data-cy="JobHistoryHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="jdemoApp.jobHistory.home.refreshListLabel">Refresh List</Translate>
          </Button>
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="jdemoApp.jobHistory.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
