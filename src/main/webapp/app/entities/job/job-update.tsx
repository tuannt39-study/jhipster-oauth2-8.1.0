  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jdemoApp.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('jdemoApp.job.jobTitle')} id="job-jobTitle" name="jobTitle" data-cy="jobTitle" type="text" />
              <ValidatedField
                label={translate('jdemoApp.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('jdemoApp.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField label={translate('jdemoApp.job.task')} id="job-task" data-cy="task" type="select" multiple name="tasks">
                <option value="" key="0" />
                {tasks
              ...
              <ValidatedField id="job-employee" name="employee" data-cy="employee" label={translate('jdemoApp.job.employee')} type="select">
                <option value="" key="0" />
                {employees
