  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jdemoApp.task.home.createOrEditLabel" data-cy="TaskCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('jdemoApp.task.title')} id="task-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('jdemoApp.task.description')}
                id="task-description"
                name="description"
                data-cy="description"
                type="text"
