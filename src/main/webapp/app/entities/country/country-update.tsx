  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jdemoApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jdemoApp.country.countryName')}
                id="country-countryName"
                name="countryName"
                data-cy="countryName"
                type="text"
              />
              <ValidatedField id="country-region" name="region" data-cy="region" label={translate('jdemoApp.country.region')} type="select">
                <option value="" key="0" />
                {regions
