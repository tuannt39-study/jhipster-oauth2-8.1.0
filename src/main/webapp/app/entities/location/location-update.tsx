  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jdemoApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jdemoApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('jdemoApp.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('jdemoApp.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('jdemoApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('jdemoApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
